...
const Navbar = () => {
  ...
  return (
    <nav className="navbar flex flex-wrap items-center justify-between p-6" style={{ backgroundColor: "rgb(185, 225, 139)" }}>
      {/* Logo */}
      <div className="flex items-center flex-shrink-0 text-[#ff6dc6] mr-6">
      ...
      <div className="block lg:hidden">
        <button
          onClick={toggleMenu}
          className="flex items-center px-3 py-2 border rounded text-[#ff6dc6] border-white hover:text-white hover:border-white"
      ...
      <div className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto ${isOpen ? "block" : "hidden"}`}>
        <div className="text-sm lg:flex-grow">
          <Link href="/" legacyBehavior>
            <a className="block mt-4 lg:inline-block lg:mt-0 text-[#ff6dc6] hover:text-white mr-4">
              Home
            </a>
          </Link>
          ...
          <Link href="/contact" legacyBehavior>
            <a className="block mt-4 lg:inline-block lg:mt-0 text-[#ff6dc6] hover:text-white">
              Contact
            </a>
          </Link>
        </div>
